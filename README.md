...
See the complete unedited run report: reports/v0_5/experiment_20260814_200609.md.
...
Exact reproduction is not guaranteed: the experimental agents are stochastic API models, the underlying served model may change, and the original dependency versions were not fully pinned. See docs/REPRODUCING.md.
...
A ready-to-use review checklist is in docs/ADVERSARIAL_REVIEW.md.
...
No API keys, .env files, virtual environments, private branch-memory databases, or local SQLite databases are included in this public package. Do not commit those files later. See SECURITY.md.
