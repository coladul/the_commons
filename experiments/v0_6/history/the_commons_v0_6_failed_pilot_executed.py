...
ARTIFACT_ROOT = ROOT / "experiments" / "v0_6" / "pilot"
...
def freeze_worlds(worlds: list[World], trials: list[Trial]) -> dict[str, Any]:
    ...
    frozen = {
        "experiment": "The Commons v0.6 Source-Linkage Test",
        "phase": "five-world engineering pilot",
        "created_at": utc_now(),
            ...
            raw_record.update(
                {
                    ...
                    "raw_responses": to_jsonable(getattr(result, "raw_responses", None)),
                    "new_items": to_jsonable(getattr(result, "new_items", None)),
                    "last_agent": to_jsonable(getattr(result, "last_agent", None)),
                }
            )
